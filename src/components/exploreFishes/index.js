...
import ExplorePage from "components/exploreFishes/explorePage";
         ...
         <section id="section-collections">
                <div className="container relative-position">
                    <div className="col-lg-12 top-100">
                        <h2>The Citadef Council members count: {props.minted}</h2>
                    </div>
                    {(props.minted!==0) && (props.fishes!==[]) && (<ReactPaginate
                        previousLabel="Previous"
                        nextLabel="Next"
                        pageClassName="btn btn-primary btn-citadef"
                        pageLinkClassName="page-link bg-info text-dark"
                        previousClassName="btn btn-primary btn-citadef"
                        previousLinkClassName="page-link text-dark"
                        nextClassName="btn btn-primary btn-citadef"
                    ...
                    <ExplorePage fishes={currentItems}  />
                </div>
            </section>
    )
}
